...
Reach a pod or service on your laptop as if it were local, with no `kubectl port-forward`
...
- **Local** address as a clickable `http://localhost:<port>` link,
- **Target** and **Pod**,
- **Cluster**,
...
-   :material-file-tree: **[Copying files](copying-files.md)** gets files in and out of a pod.
-   :material-console: **[Shell & debug](shell.md)** gives you a terminal into the container instead.
